			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'outdoortextilehikka@gmail.com';     
				        $mail->Password = 'outdoor366';                    
				        ...
				        $mail->setFrom('outdoortextilehikka@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('outdoortextilehikka@gmail.com');
				       
				        //Content
				        $mail->isHTML(true);                                  
				        $mail->Subject = 'OutDoor Sign Up';
				        $mail->Body    = $message;
